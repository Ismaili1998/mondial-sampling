    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('packaging_fee', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ...
                ('quoteRequest', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='project.quoterequest')),
            ],
        ),
        migrations.CreateModel(
