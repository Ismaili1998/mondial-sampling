    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_name', models.CharField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_ref', models.CharField(max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('supplier_nbr', models.CharField(max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True)),
                ('phone_number', models.CharField(blank=True, max_length=20, null=True)),
                ('project', models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='project.project')),
            ],
            options={
                'db_table': 'buyer',
            },
